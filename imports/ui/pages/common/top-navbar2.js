...
Template.topNavbar2.rendered = function(){
...
Template.topNavbar2.onDestroyed (function(){
    //_thisProject.stop();
    _changeMessage.stop();
});


Template.topNavbar2.onCreated(function() {
...
Template.topNavbar2.helpers({
    //左边的项目名称
    thisProjectName: function() {
        if(Project.find({_id:choosepro}).fetch()[0]){
            return Project.find({_id:choosepro}).fetch()[0].proname;
        }
    },
    //消息框左边栏项目列表
    ...
    messageList: function() {
        ...
        for(var i=0;i<bendiMT.length;i++){
            ...
            //Users.find({_id:bendiMT[i].senderId}).fetch()[0].type
        }
    ...
    'change #uploadHead':function(e){
        ...
        reader.onload = (function (file){
            return function (e){
                ...
                //console.log(base64);
                Meteor.call('uploadHeadPic',base64,loguser);
            };
        })(e.target.files[0]);
        reader.readAsDataURL(e.target.files[0]);
        //console.log(base64);
